<template>
  <div class="createTwoStateSwitchWrapper">
    <div class="switchBody">
      ...
      <input type="text" v-model="inputName" placeholder="Nazwa monitora">
      <input type="text" v-model="inputPrefix" placeholder="Prefix">
      <input type="text" v-model="inputSufix" placeholder="Sufix">
      <div>
...
export default {
  ...
  data() {
    return {
      ...
      inputPrefix: this.compDict.prefix,
      inputSufix: this.compDict.sufix,
  ...
  methods: {
    createNewDict(){
      return {active: (typeof this.toggle) === 'undefined' ? false : this.toggle,
              ...
              sufix: this.inputSufix ? this.inputSufix : '',
              prefix: this.inputPrefix ? this.inputPrefix : '',
              type: 'display_info',
